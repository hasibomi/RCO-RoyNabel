    			...
    			<div class="portfolio-item">
    				<div class="row">
    					<div class="col-md-4">
    						...
    						<h4 id="mobileoffice"><a href="<?= site_url('member/home/mobilesupport')?>" class="custom-a">Mobile Office</a></h4>
    					</div> <!-- /.col-md-4 -->
    					<div class="col-md-4">
    						<a href="<?= site_url('member/home/csvsupport')?>">
    							<img class="img-responsive" src="<?php echo base_url() ?>public/images/csveditor.png">
    						</a>
    						<h4 id="csv"><a href="<?= site_url('member/home/csvsupport')?>" class="custom-a">CSV Editor</a></h4>
    					</div> <!-- /.col-md-4 -->
    					<div class="col-md-4">
    						<a href="<?= site_url('member/home/labelsupport')?>">
    							<img class="img-responsive" src="<?php echo base_url() ?>public/images/Label_state1_02.png">
    						</a>
    						<h4 id="labels"><a href="<?= site_url('member/home/labelsupport')?>" class="custom-a">Labels</a></h4>
    					</div> <!-- /.col-md-4 -->
    				</div> <!-- /.row -->
    				...
    				<div class="row">
    					<div class="col-md-4">
    						...
    						<h4 id="scan"><a href="<?= site_url('member/home/scansupport')?>" class="custom-a">Scan</a></h4>
    					</div> <!-- /.col-md-4 -->
    					<div class="col-md-4">
    						<a href="<?= site_url('member/home/publishsupport')?>">
    							<img class="img-responsive" src="<?php echo base_url() ?>public/images/Publish_state1_02.png">
    						</a>
    						<h4 id="publish"><a href="<?= site_url('member/home/publishsupport')?>" class="custom-a">Publish</a></h4>
    					</div> <!-- /.col-md-4 -->
    				</div> <!-- /.row -->
    			</div> <!-- /.portfolio-item -->
    		</div> <!-- /.col-md-12 -->
