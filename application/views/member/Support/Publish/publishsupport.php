            ...
            <div class="custom-container">
                <div class="col-md-3 col-sm-4 sidebar">
                    <ul class="nav nav-stacked nav-pills">
                        ...
                        <li>
                            <a href="<?= site_url('member/home/publishmanual'); ?>">
                                <img src="<?= base_url(); ?>public/images/manual.png" width="30" height="30" >
                                Manuals
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('member/home/publishphone'); ?>">
                        ...
                        <li>
                            <a href="<?= site_url('member/home/publishvideo'); ?>">
                                <img src="<?= base_url(); ?>public/images/youtube.png" width="40" height="30" >
                                Videos
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('member/home/publishdownload'); ?>">
                ...
                <div id="support">
                    <div class="col-md-9">
                        <h3>Welcome</h3>
                        <p>
                            <a href="<?= site_url('member/home/publishvideo'); ?>">Watch videos</a>, <a href="<?= site_url('member/home/publishmanual'); ?>">read the manual</a> and <a href="<?= site_url('member/home/publishphone'); ?>">contact support</a>
                        </p>
