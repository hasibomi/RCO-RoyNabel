        ...
        <div class="row">
            ...
            <div class="row">
            	...
            	<div class="col-md-4 portfolio-item">
                    ...
                    <a class="btn btn-default btn-sm pull-right" href="<?php echo site_url('member/home/mobileoffice') ?>">More <i class="fa fa-angle-right"></i></a>
                </div>
                ...
                <div class="col-md-4 portfolio-item">
                    ...
                    <a class="btn btn-default btn-sm pull-right" href="<?php echo site_url('member/home/csveditor') ?>">More <i class="fa fa-angle-right"></i></a>
                </div>
                <div class="col-md-4 portfolio-item">
                    ...
                    <a class="btn btn-default btn-sm pull-right" href="<?php echo site_url('member/home/label') ?>">More <i class="fa fa-angle-right"></i></a>
                </div>
                <div class="col-md-4 portfolio-item">
                    ...
                    <a class="btn btn-default btn-sm pull-right" href="<?php echo site_url('member/home/scan') ?>">More <i class="fa fa-angle-right"></i></a>
                </div>
                <div class="col-md-4 portfolio-item">
                    <img class="img-responsive" src="<?php echo base_url() ?>public/images/Publish_state1_02.png">
                    <h3>Publish</h3>
                    <p>Service three description. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc placerat diam quis nisl vestibulum dignissim. In hac habitasse platea....</p>
                    <a class="btn btn-default btn-sm pull-right" href="<?php echo site_url('member/home/publish') ?>">More <i class="fa fa-angle-right"></i></a>
                </div>
